...
/**
 * The ShipButtonListener listens for radio button clicks selecting different
 * ships in the ship type panel.
 * 
 * @author Maggie
 *
 */
public class ShipButtonListener implements ActionListener
{
	 ...
	 * 
	 * @param shipDataPanel
	 *            This is the panel that will change contents based on a click.
	 */
	...
	/**
	 * Depending on which radio button was clicked, have the ship data panel set up
