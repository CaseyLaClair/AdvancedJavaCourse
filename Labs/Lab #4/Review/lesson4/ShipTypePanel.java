...
/**
 * The ShipTypePanel allows the user to choose a Ship. When the user chooses a
 * type of ship, the ShipDataPanel will update.
 * 
 * @author Maggie
 *
 */
...
public class ShipTypePanel extends JPanel
{
	...
	public String getCurrentShipType()
	{
		...
		if (shipButton.isSelected())
			...
			return "Error: no ship type is selected";
	}
}
